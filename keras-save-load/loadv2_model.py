# -*- coding: utf-8 -*-
"""
Created on Fri Aug  2 09:35:04 2019
...
model = load_model("saved_DogsAndCats_modelv2.model")

# grab all image paths in the input directory and randomly sample them
imagePaths = list(paths.list_images("catsAndDogsSmall\testing"))

# these two lines randomly choose 16 (we dont want that do we)
'''
...
for p in imagePaths:
	...
	label = "Cats" if pred == 0 else "Dogs"
